...
import {clock, arrowRightDoubleLine, arrowLeftDoubleLine, arrowLeftSLine, arrowRightSLine, toggle, empty, errorIcon, orangeSatusIcon, greenSatusIcon, arrowDown} from '../constants/constant';
