...
function GuageChart({chart_Data}) {
  // Handle empty or non-array chartData
  const chartData = chart_Data || [];  // Use empty array as default
...
GuageChart.propTypes = {
  chart_Data: PropTypes.arrayOf(PropTypes.number)  // if it's an array of numbers
};
